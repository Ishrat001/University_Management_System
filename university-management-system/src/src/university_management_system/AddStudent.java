...
public class AddStudent extends JFrame implements ActionListener {
	...
	AddStudent(){
		...
		submit.setBounds(200, 490, 120, 30);
		...
		cancel.setBounds(500, 490, 120, 30);
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource() == submit) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Student Details Inserted Succsessfully");
				setVisible(false);
